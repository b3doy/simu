    ...
    <div class="row">
        <div class="col">
            <div class="row noprint">
                <div class="col-10">
                    <h2>Cetak Kwitansi Pelunasan</h2>
                </div>
                <div class="col-md-2">
                    <a href="<?= base_url('/kwitansi/kwitansipelunasan'); ?>" class="btn btn-secondary" role="button"><i class="fa fa-undo"></i> Kembali</a>
                </div>
            </div>
            <form action="<?= base_url('/kwitansi/printpelunasan'); ?>" method="POST">
                                ...
                                <div class="col">
                                    <table class="table-sm huruf">
                                        ...
                                        <tr>
                                            ...
                                            <td>:&nbsp</td>
                                            <td><input type="text" name="angsuran_ke" class="form-aing" value="Pelunasan" readonly></td>
                                        </tr>
                                        <tr>
                                            <td>Jumlah Uang</td>
                                            <td>:&nbsp</td>
                                            <td> <?= $konverter->terbilang($akun['ambil']); ?> </td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
                            ...
                            <table class="table table-bordered huruf">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="width: 40%;">Pelunasan</td>
                                        <td style="width: 30%;"><input type="text" class="form-aing text-right" name="pembayaran_angsuran" value="<?= $konverter->rupiah02($akun['ambil'] + $akun['diskon']); ?>" readonly></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <td style="width: 40%;">Diskon</td>
                                        <td style="width: 30%;"><input type="text" class="form-aing text-right" name="pembayaran_dp" value="<?= $konverter->rupiah02($akun['diskon']); ?>" readonly></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <th>TOTAL YANG HARUS DIBAYAR</th>
                                        <th><input type="text" name="total_pembayaran" class="form-aing fw-bolder text-right" value="<?= $konverter->rupiah02($akun['ambil']); ?>" readonly>
