...
<head>
    ...
    <title>Kwitansi Permission</title>
...
<body>
    ...
    <nav class="navbar navbar-light bg-light">
        <div class="container">
            <img src="<?= base_url(); ?>/public/assets/img/mbz.png" style="width: 100px;" alt="logo">
            <form class="d-flex">
                <a class="navbar-brand nav-link" href="<?= base_url('/page'); ?>">Home</a>
            </form>
        </div>
    </nav>
        ...
        <div class="row">
            <div class="col-8">
                <div class="card" id="logCard">
                    <div class="card-body">
                        <h4>Silahkan Masukkan Password Untuk Melanjutkan</h4>
                        <form action="<?= base_url('/kwitansi/lanjut'); ?>" method="POST">
                            <input type="password" class="form-control" name="pass_lanjut_kwitansi">
                            <button type="submit" name="lanjut" class="btn btn-success btn-sm mt-3"><i class="fa fa-paper-plane"></i> Lanjut</button>
                        </form>
                    </div>
                </div>
            </div>
