        ...
        <div class="col-8">
            ...
            <form action="<?= base_url('/pegawai/save'); ?>" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="jabatan" name="jabatan" value="<?= old('nama_pegawai'); ?>" required>
                </div>
                <div class="mb-3">
                    <label for="telpon" class="form-label">Telpon</label>
                    <input type="text" class="form-control" id="telpon" name="telpon" value="<?= old('nama_pegawai'); ?>" required>
                </div>
                <div class="mb-3">
