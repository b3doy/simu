...
<div class="container mt-3">
    <div class="row">
        <div class="col">
            <h3 class="mb-5">Laporan Data / Konsumen Aktif</h3>
            <table class="table table-hover table-sm mt-4 hurufKecil" id="dataAktifTable">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Tanggal</th>
...
<script>
    var table = $('#dataAktifTable').DataTable({
        "order": [],
        "processing": true,
        "serverside": true,
        "ajax": {
            "url": "<?= base_url('/report/dataAktifTable'); ?>",
            "type": "POST"
        },
        "columnDefs": [{
            "targets": [0],
