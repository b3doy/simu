...
<div class="container mt-3">
    <div class="row">
        <div class="col">
            <h1 class="mb-5">Data Konsumen Akan Lunas Dalam 90 Hari</h1>
            <table class="table table-hover mt-4" id="konsumenAkanLunasTable">
...
<script>
    table = $('#konsumenAkanLunasTable').DataTable({
        "order": [],
        "processing": true,
        "serverside": true,
        "ajax": {
            "url": "<?= base_url('/konsumen/konsumenAkanLunasTable'); ?>",
            "type": "POST"
        },
        "columnDefs": [{
            "targets": [0],
