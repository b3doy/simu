        ...
        <div class="col">
            ...
            <form action="<?= base_url('/konsumen/update/' . $konsumen['id']); ?>" method="POST">
                ...
                <div class="row backKonsumen">
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control <?= ($validation->hasError('nama_konsumen')) ? 'is-invalid' : ''; ?>" id="nama_konsumen" name="nama_konsumen" value="<?= (old('nama_konsumen')) ? old('nama_konsumen') : $konsumen['nama_konsumen']; ?>" readonly>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control <?= ($validation->hasError('no_ktp')) ? 'is-invalid' : ''; ?>" id="no_ktp" name="no_ktp" value="<?= (old('no_ktp')) ? old('no_ktp') : $konsumen['no_ktp']; ?>" readonly>
                            <div id="validationServer03Feedback" class="invalid-feedback">
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control <?= ($validation->hasError('tgl_lahir')) ? 'is-invalid' : ''; ?>" id="tgl_lahir" name="tgl_lahir" value="<?= (old('tgl_lahir')) ? old('tgl_lahir') : $konsumen['tgl_lahir']; ?>" readonly>
                            <div id="validationServer03Feedback" class="invalid-feedback">
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control <?= ($validation->hasError('pekerjaan')) ? 'is-invalid' : ''; ?>" id="pekerjaan" name="pekerjaan" value="<?= $konsumen['pekerjaan']; ?>" readonly>
                            <div id="validationServer03Feedback" class="invalid-feedback">
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control <?= ($validation->hasError('telpon')) ? 'is-invalid' : ''; ?>" id="telpon" name="telpon" value="<?= (old('telpon')) ? old('telpon') : $konsumen['telpon']; ?>" readonly>
                            <div id="validationServer03Feedback" class="invalid-feedback">
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control <?= ($validation->hasError('no_kk')) ? 'is-invalid' : ''; ?>" id="no_kk" name="no_kk" value="<?= (old('no_kk')) ? old('no_kk') : $konsumen['no_kk']; ?>" readonly>
                            <div id="validationServer03Feedback" class="invalid-feedback">
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control <?= ($validation->hasError('ibu_kandung')) ? 'is-invalid' : ''; ?>" id="ibu_kandung" name="ibu_kandung" value="<?= (old('ibu_kandung')) ? old('ibu_kandung') : $konsumen['ibu_kandung']; ?>" readonly>
                            <div id="validationServer03Feedback" class="invalid-feedback">
                    ...
                    <div class="col-md-8">
                        <div class="mb-3">
                            ...
                            <textarea name="alamat" id="alamat" class="form-control <?= ($validation->hasError('alamat')) ? 'is-invalid' : ''; ?>" readonly><?= (old('alamat')) ? old('alamat') : $konsumen['alamat']; ?></textarea>
                            <div id="validationServer03Feedback" class="invalid-feedback">
                ...
                <div class="row backPasangan">
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control <?= ($validation->hasError('nama_pasangan')) ? 'is-invalid' : ''; ?>" id="nama_pasangan" name="nama_pasangan" value="<?= (old('nama_pasangan')) ? old('nama_pasangan') : $konsumen['nama_pasangan']; ?>" readonly>
                            <div id="validationServer03Feedback" class="invalid-feedback">
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control <?= ($validation->hasError('ktp_pasangan')) ? 'is-invalid' : ''; ?>" id="ktp_pasangan" name="ktp_pasangan" value="<?= (old('ktp_pasangan')) ? old('ktp_pasangan') : $konsumen['ktp_pasangan']; ?>" readonly>
                            <div id="validationServer03Feedback" class="invalid-feedback">
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control <?= ($validation->hasError('tgl_lahir_pasangan')) ? 'is-invalid' : ''; ?>" id="tgl_lahir_pasangan" name="tgl_lahir_pasangan" value="<?= (old('tgl_lahir_pasangan')) ? old('tgl_lahir_pasangan') : $konsumen['tgl_lahir_pasangan']; ?>" readonly>
                            <div id="validationServer03Feedback" class="invalid-feedback">
                    ...
                    <div class="col-md-8">
                        <div class="mb-3">
                            ...
                            <textarea name="alamat_ktp_pasangan" id="alamat_ktp_pasangan" class="form-control <?= ($validation->hasError('alamat_ktp_pasangan')) ? 'is-invalid' : ''; ?>" readonly><?= (old('alamat_ktp_pasangan')) ? old('alamat_ktp_pasangan') : $konsumen['alamat_ktp_pasangan']; ?></textarea>
                            <div id="validationServer03Feedback" class="invalid-feedback">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="domisili" id="domisili" class="form-control <?= ($validation->hasError('domisili')) ? 'is-invalid' : ''; ?>" readonly><?= $konsumen['domisili']; ?></textarea>
                    <div id="validationServer03Feedback" class="invalid-feedback">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control angka3 <?= ($validation->hasError('dp')) ? 'is-invalid' : ''; ?>" id="dp" name="dp" value="<?= old('dp') ? old('dp') : $konverter->rupiah02($konsumen['dp']); ?>" onkeyup="hitungOs()" autofocus>
                    <div id="validationServer03Feedback" class="invalid-feedback">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control <?= ($validation->hasError('tanggal_datang')) ? 'is-invalid' : ''; ?>" id="tanggal_datang" name="tanggal_datang" value="<?= old('tanggal_datang') ? old('tanggal_datang') : $konsumen['tanggal_datang']; ?>" onkeyup="skemaPembayaran()" readonly>
                    <div id="validationServer03Feedback" class="invalid-feedback">
                ...
                <div class="mb-3">
                    ...
                    <select name="marketing" id="marketing" class="form-control" readonly>
                ...
                <div class="mb-3">
                    ...
                    <select name="surveyor" id="surveyor" class="form-control" readonly>
                ...
                <div class="mb-3">
                    ...
                    <select name="status_approval" id="status_approval" class="form-control bg-warning <?= ($validation->hasError('status_approval')) ? 'is-invalid' : ''; ?>">
                    ...
                    <div id="validationServer03Feedback" class="invalid-feedback">
                        <?= $validation->getError('status_approval'); ?>
                    </div>
                </div>
                <div class="mb-3">
                    <label for="deskripsi_survey" class="form-label">Deskripsi</label>
                    <textarea name="deskripsi_survey" id="deskripsi_survey" class="form-control <?= ($validation->hasError('deskripsi_survey')) ? 'is-invalid' : ''; ?>"></textarea>
                    <div id="validationServer03Feedback" class="invalid-feedback">
                        <?= $validation->getError('deskripsi_survey'); ?>
                    </div>
                </div>
                <input type="hidden" name="waktu_update_surveyor" value="<?= date('Y-m-d H:i:s'); ?>">
